...
## Project Structure
    ...
    ├── testapiautostorybo_104208  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_104208`
...
2. Clone this repo and `cd testapiautostorybo_104208`
